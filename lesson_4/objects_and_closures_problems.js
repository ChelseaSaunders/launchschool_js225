...
// We resume our discussion of objects and closures by examining an earlier
// practice problem where we built a function named makeList to manage a todo
...
// This single-function solution provides a concise, but somewhat unclear,
...
// appropriate arguments. This code works, but it's unclear. In fact, the
// single call list('make breakfast') can perform two entirely different
// operations based on the current state of the list!

// We can improve the interface by returning an Object from makeList instead of
// a single Function. If we do that, we can create an interface that is easy to
// use and understand:
...
// Notice that the solution lets us access the array of items through the items
// property:
